...
export default class FlightDetail extends Component {
  ...
  displaySelectedPrices = () => {
    ...
    if (outboundFlight.segments.length > 1) {
      firstRender = (
        <>
          ...
          <div className="flight-item">
            <li>{outboundFlight.segments[1].flightSegment.arrival.iataCode}</li>
            <li>
              {outboundFlight.segments[1].flightSegment.arrival.at.slice(0, 10)}
            </li>
            <li>
    ...
    if (returnFlight.segments.length > 1) {
      secondRender = (
        <>
          <div className="flight-item">
            <li>{returnFlight.segments[1].flightSegment.departure.iataCode}</li>
            <li>
              {returnFlight.segments[1].flightSegment.departure.at.slice(0, 10)}
            </li>
            <li>
          ...
          <div className="flight-item">
            <li>{returnFlight.segments[1].flightSegment.arrival.iataCode}</li>
            <li>
              {returnFlight.segments[1].flightSegment.arrival.at.slice(0, 10)}
            </li>
            <li>
              {returnFlight.segments[1].flightSegment.arrival.at.slice(11, 16)}
            </li>
          </div>
        </>
      );
        ...
        <div className="flight-container flex-container rounded border border-light">
          <div className="flight-schedule">
            ...
            <div className="outbound-container flex-container">
              ...
              <div className="second-flight flex-container">{firstRender}</div>
            </div>
            <p className="from-to">
              Return{" "}
            ...
            <div className="return-container flex-container">
              ...
              <div className="second-flight flex-container">{secondRender}</div>
            </div>
  ...
  render() {
    ...
    return (
      <div>
        <h2 className="flight-detail-message">Confirm flight detail</h2>
        <div>{this.displaySelectedPrices()}</div>

        <div>
          <h2 className="flight-detail-message">Input Passenger Detail</h2>
          <div className="passenger-form bg-opacity rounded p-3">
